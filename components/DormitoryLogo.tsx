export const DormitoryLogo = ({ className = "w-28 h-28" }: { className?: string }) => (
  <svg viewBox="0 0 200 200" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="72" cy="100" r="7" fill="#2563EB" />
    <rect x="85" y="94" width="50" height="14" rx="3" fill="#2563EB" />
    <line x1="60" y1="112" x2="140" y2="112" stroke="#2563EB" strokeWidth="6" strokeLinecap="round" />
    <circle cx="72" cy="132" r="7" fill="#2563EB" />
    <rect x="85" y="126" width="50" height="14" rx="3" fill="#2563EB" />
    <line x1="60" y1="144" x2="140" y2="144" stroke="#2563EB" strokeWidth="6" strokeLinecap="round" />
  </svg>
);
