  ...
  <svg viewBox="0 0 200 200" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <linearGradient id="dormitory-logo-gradient" x1="0" y1="0" x2="200" y2="200" gradientUnits="userSpaceOnUse">
        <stop offset="0" stopColor="#F0709A" />
        <stop offset="1" stopColor="#4C3AA6" />
      </linearGradient>
    </defs>
    ...
    <circle cx="72" cy="100" r="7" fill="#7C6CF0" />
    <rect x="85" y="94" width="50" height="14" rx="3" fill="#7C6CF0" />
    <line x1="60" y1="112" x2="140" y2="112" stroke="#7C6CF0" strokeWidth="6" strokeLinecap="round" />
    <circle cx="72" cy="132" r="7" fill="#7C6CF0" />
    <rect x="85" y="126" width="50" height="14" rx="3" fill="#7C6CF0" />
    <line x1="60" y1="144" x2="140" y2="144" stroke="#7C6CF0" strokeWidth="6" strokeLinecap="round" />
  </svg>
);
